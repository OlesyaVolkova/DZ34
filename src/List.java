...
public class List {
    ...
    public void insert(int data, int position) { //вставляет значение в список по указанному индексу;
    ...
    public void erase(int pos) { //удаляет элемент из списка по указанному индексу;
        if (Head == null) {
            return;
        }
